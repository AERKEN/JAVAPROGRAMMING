...
public class ArraysUtility {
    ...
    //add a given integer element to the given array
    ...
    //add a given double element to the given array
    ...
    //add a given char element to the given array
    ...
    //removes the index from the double array, returns new double array
    ...
    //removes the index from the char array, returns new char array
    ...
    //reverse the array ,returns the new int array
    ...
    //reverse the array ,returns the new double array
    ...
    //reverse the array ,returns the new char array
    ...
    //reverse the array ,returns the new String array
